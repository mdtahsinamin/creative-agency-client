       ...
       <section className='footer-section mt-5'>
           ...
           <div style={{height:'600px'}} className='row d-flex justify-content-center mt-5'>
            ...
            <form action="">
                ...
                <input type="text" className="form-control input-group" placeholder="Your Email Address *"/>
                </div>

                <div className="form-group">
                <input type="text" className="form-control input-group" placeholder="Your name / company’s name *"/>
                </div>
