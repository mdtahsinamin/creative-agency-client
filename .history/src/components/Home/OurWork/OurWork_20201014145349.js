    ...
    return (
        <section  className='mt-5 pt-5 mb-5 our-works-container'>
            ...
            <div style={{height:'600px'}} className="d-flex align-items-center justify-content-center">
                ...
                <>
                <Slider {...settings}>
                    <div className="carousel mr-3">
                       <img className='carousel-img img-fluid' src={carouselImgFirst} alt=""/>
                    </div>
                    <div className="carousel mr-3">
                      <img className='carousel-img img-fluid' src={carouselImgSecond} alt=""/>
                    </div>
                    <div className="carousel mr-3">
                       <img className='carousel-img img-fluid' src={carouselImgThird} alt=""/> 
                    </div>
                    <div className="carousel mr-3">
                       <img className='carousel-img img-fluid' src={carouselImgFour} alt=""/>
                    </div>
                    <div className="carousel mr-3">
                       <img className='carousel-img img-fluid' src={carouselImgFive} alt=""/>
                    </div>
                     </Slider>
                    </>
                </div>
