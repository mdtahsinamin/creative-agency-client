...
const OurWork = () => {
    let settings = {
      ...
      const carouselImg =[  
      {index:1,img:carouselImgFirst},{index:2,img:carouselImgSecond},
      {index:3,img:carouselImgThird},{index:4,img:carouselImgFourth},
      {index:5,img:carouselImg}
     ]
        ...
        <section  className='mt-5 pt-5 mb-5 our-works-container'>
            ...
            <div className="d-flex align-items-center justify-content-center">
                ...
                <Slider {...settings}> 
                   ...
                   <div>
                       <img src={carouselImgFirst} alt=""/>
                   </div>
                   <div>
                      <img src={carouselImgSecond} alt=""/>
                   </div>
                   <div>
                      <img src={carouselImgThird} alt=""/>
                   </div>
                   
                   <div>
                      <img src={carouselImgFour} alt=""/>
                   </div>
                   
                   <div>
                      <img src={carouselImgFive} alt=""/>
                   </div>
