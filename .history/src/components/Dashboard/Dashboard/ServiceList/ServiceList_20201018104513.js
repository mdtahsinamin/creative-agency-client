        ...
        <section className="container-fluid row">
            ...
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="">Service</StyledTableCell>
                <StyledTableCell align="">Project Details</StyledTableCell>
            ...
            <TableBody>
               {
                 ...
                 allCustomer.map(customer=> <CustomerList customer={customer} key={customer._id}></CustomerList>
                )
               }
              </TableBody>  
               </Table>
