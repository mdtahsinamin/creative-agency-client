             ...
             <form onSubmit={handleSubmit(onSubmit)}>
                 <div className='d-flex ml-5'>
                    ...
                    <div className='mr-4'>
                        ...
                        <input type="text" name='serviceTitle' className='form-control serviceTitle' ref={register} placeholder='Enter Title'/>
                    </div>
                  ...
                  <div>
                      <h6>Description</h6>
                      <textarea name="projectDetails" className="form-control" id="" cols="25" rows="5" ref={register} placeholder="Description *"></textarea>
                  </div>
