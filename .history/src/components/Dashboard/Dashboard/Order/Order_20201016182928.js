               ...
               <div className="col-md-9 order-place p-4 pl-5" >
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                       ...
                       <div className="row mt-4">
                           ...
                           <input type="text" name='name' defaultValue={loginUser.currentName} className='form-control' ref={register} placeholder='Your name / company’s name'/>

                           </div>

                           <div className="col-md-12 order-section mb-3">
                               
                             <input type="email" name="email" defaultValue={loginUser.currentEmail} className="form-control" ref={register({ required: true })} placeholder='Your email address'/> 
