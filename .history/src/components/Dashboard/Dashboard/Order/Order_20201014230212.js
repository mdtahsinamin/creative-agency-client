                 ...
                 <div className='order-place pl-5'>
                     ...
                     <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <input type="text" name="course" className="form-control" ref={register({ required: true })} placeholder='Graphic Design'/>
                         ...
                         <div className="input-group">
                         <textarea name="projectDetails" className="form-control" id="" cols="30" rows="10" placeholder="Your message *"></textarea>
                         </div>

                        <input type="submit" value='Send' className='hireUs-btn'/>
                    </form>
                     </div>
                 </div>
            </div>
