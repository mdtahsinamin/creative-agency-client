...
const CustomerServiceList = () => {
     ...
     useEffect(()=>{
        ...
        async function loadData(){
           ...
           const request =  await fetch(`https://whispering-eyrie-37325.herokuapp.com/clientEnrollServices?email=${(loginUser.email||loginUser.currentEmail)}`,{
              method: 'GET',
              headers: { 
        ...
        <h5 className="text-brand mt-2">Service List</h5> 
          ...
          <div className=''>
             <div className="row">
               ...
               {  customerService.length === 0 ? <CircularProgress/>:
