              ...
              <Link to='/' className="navbar-brand"><img className="agencyLogo" src={agencyLogo} alt=""/></Link>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto">
                      <Link className="nav-link mr-3 mt-5" to="/home">Home <span className="sr-only">(current)</span></Link>
                      <Link className="nav-link mr-3 mt-5" to="/portfolios">Our Portfolio</Link>
                      <Link className="nav-link mr-3 mt-5" to="/ourTeam">Our Team</Link>
                      <Link className="nav-link mr-3 mt-5" to="/contactUs">Contact Us</Link>
