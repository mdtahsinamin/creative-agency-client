               ...
               <Link to='/' className="navbar-brand"><img className="agencyLogo" src={agencyLogo} alt=""/></Link>
                ...
                <Navbar.Collapse id="basic-navbar-nav" className='mt-5 pt-3'>
                    <Nav className="ml-auto">
                      ...
                      {!(loginUser.email||loginUser.currentEmail || currentEmail ) && <button onClick={handleChange} className='login-btn mr-4 mt-2'>Login</button>}
                       {(loginUser.email||loginUser.currentEmail||currentEmail )&& <button onClick={handleLogoutUser} className='login-btn mr-4'>Logout</button>}
                    </Nav>
                </Navbar.Collapse>
        </Navbar>
       </div>
