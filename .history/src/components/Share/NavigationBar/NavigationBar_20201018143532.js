               ...
               <Link to='/' className="navbar-brand"><img className="agencyLogo" src={agencyLogo} alt=""/></Link>
                ...
                <Navbar.Collapse id="basic-navbar-nav" className='mt-5 pt-3'>
                    <Nav className="ml-auto">
                      ...
                      <Link className="nav-link mr-4" to="/portfolios">Our Portfolio</Link>
                      <Link className="nav-link mr-4" to="/ourTeam">Our Team</Link>
                      <Link className="nav-link mr-4" to="/contactUs">Contact Us</Link>
