...
const Order = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch("https://creative-agency-server-2ogx.vercel.app/clientEnrollCourse", {
      method: "POST",
      body: formData,
    })
          ...
          <div className="row mt-4">
            <div className="col-md-12 order-section mb-3">
              <input
                type="text"
                name="name"
                defaultValue={loginUser.currentName || loginUser.name}
            ...
            <div className="col-md-12 order-section mb-3">
              <input
                type="email"
                name="email"
                defaultValue={loginUser.currentEmail || loginUser.email}
                className="form-control"
            ...
            <div className="col-md-4 order-label">
              ...
              <label htmlFor="file">
                ...
                <span className="upload"> {fileName}</span>
              </label>
            </div>
          </div>
